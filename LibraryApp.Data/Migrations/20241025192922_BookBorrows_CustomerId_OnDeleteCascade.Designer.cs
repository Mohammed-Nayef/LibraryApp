...
namespace LibraryApp.Data.Migrations
{
    ...
    [Migration("20241025192922_BookBorrows_CustomerId_OnDeleteCascade")]
    partial class BookBorrows_CustomerId_OnDeleteCascade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryApp.Domain.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(561),
                            Email = "johndoe@example.com",
                            FirstName = "John",
                            IsDeleted = false,
                            LastName = "Doe",
                            LastUpdatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(562),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(567),
                            Email = "janesmith@example.com",
                            FirstName = "Jane",
                            IsDeleted = false,
                            LastName = "Smith",
                            LastUpdatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(568),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(572),
                            Email = "aliceauthor@example.com",
                            FirstName = "Alice",
                            IsDeleted = false,
                            LastName = "Johnson",
                            LastUpdatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(573),
            ...
            modelBuilder.Entity("LibraryApp.Domain.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AuthorId = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(1303),
                        ...
                        new
                        {
                            ...
                            AuthorId = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(1386),
            ...
            modelBuilder.Entity("LibraryApp.Domain.Models.BookBorrow", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(1472),
                            CustomerId = 1,
                            ExpiryDate = new DateTime(2024, 11, 8, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(1473)
                        },
                        new
                        {
                            Id = 2,
                            BookId = 2,
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(1480),
                            CustomerId = 1,
                            ExpiryDate = new DateTime(2024, 11, 8, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(1481)
                        });
                });
            ...
            modelBuilder.Entity("LibraryApp.Domain.Models.Tag", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(1241),
                            Name = "C#"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(1244),
                            Name = "ASP.NET"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(1247),
                            Name = "Web Development"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(1249),
                            Name = "Fantasy"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 10, 25, 19, 29, 21, 728, DateTimeKind.Utc).AddTicks(1252),
                            Name = "Biography"
                        });
                });
            ...
            modelBuilder.Entity("LibraryApp.Domain.Models.BookTag", b =>
                {
                    ...
                    b.HasOne("LibraryApp.Domain.Models.Tag", "Tag")
                        .WithMany("BookTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
